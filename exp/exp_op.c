...
void
op_push (struct operator_stack *og_ptr, char op)
{
...
char
op_pop (struct operator_stack *og_ptr)
{
  ...
  for (traverse = og_ptr->head; traverse != og_ptr->tail;
...
void
op_free (struct operator_stack *og_ptr)
{
...
void
op_destroy (struct operator_stack *og_ptr)
{
