...
struct data *
str_add_op (struct data *a, struct data *b)
{
...
struct data *
str_mul_op (struct data *a, struct data *b)
{
...
int
str_convert (struct data *ptr, char *s)
{
...
struct data *
str_find_op (struct data *src, struct data *in, int nbytes)
{
...
struct data *
str_compare_op (struct data *src, struct data *in, int nbytes)
{
...
struct data *
str_replace_op (struct data *src, struct data *what, struct data *by)
{
...
struct data *
str_operate (struct data *a, struct data *b, int op)
{
  ...
  switch (op)
	...
	(char *) malloc (sizeof (char) *
			 (strlen (src_ptr) + strlen (dst_ptr) + 1));
      if (!res)
	{
...
struct data *
deinstall_string (struct data *ptr)
{
