...
void
stack_push (struct variable *var, unsigned long lookup_stop)
{
...
struct stack *
stack_trace (char *key, unsigned long lookup_stop)
{
...
struct data *
stack_lookup (char *key, unsigned long lookup_stop)
{
...
void
stack_destroy (unsigned long extent)
{
...
void
stack_free (struct variable *var)
{
