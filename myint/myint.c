...
struct data *
int_ones_complement (struct data *a)
{
...
struct data *
int_add_op (struct data *a, struct data *b)
{
...
struct data *
int_sub_op (struct data *a, struct data *b)
{
...
struct data *
int_mul_op (struct data *a, struct data *b)
{
...
struct data *
int_div_op (struct data *a, struct data *b)
{
...
struct data *
int_compare_op (struct data *a, struct data *b, int op)
{
...
struct data *
int_bit_op (struct data *a, struct data *b, int op)
{
...
struct data *
int_operate (struct data *a, struct data *b, int op)
{
